...
public class HtmlUtils {
    ...
    public static String markdown2Html(String markdown, int bottom) {
        ...
        return renderer.render(document).replace(MARKER, "<a href='#' id='_" + MARKER + "'/>");
    }
    ...
    public static void main(String[] args) {
        //System.out.println(HtmlUtils.markdown2Html(TEST_MD, 10));
